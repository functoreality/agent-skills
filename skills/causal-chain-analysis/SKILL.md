...
4. 逐节点展开（示意）：
	...
	- 展开"人体电位偏离地电位多"：用公式 V=Q/C 拆分为 人体净电荷量多 **×** 人体对地电容小
	- 展开"人体净电荷量多"：用公式 Q_net=Q_gen−Q_leak 拆分为 人体电荷产生量多 **+** 人体电荷散失量少
	- 展开"电荷产生量多"：用公式 Q_gen=Q_衣物摩擦+Q_鞋底摩擦 拆分为 衣物与皮肤摩擦产生电荷多 **+** 鞋底与地面摩擦产生电荷多
	- 展开"衣物与皮肤摩擦产生电荷多"：用摩擦起电公式 Q∝ΔT×A×N 拆分为 摩擦起电序列位置差距大 **×** 接触面积大 **×** 反复接触分离次数多
	- ……
	- 展开"摩擦起电序列位置差距大"：用公式 ΔT=T_衣物−T_皮肤 拆分为 衣物材料序列位置偏向一端 **+** 人体皮肤序列位置偏向另一端（两者均判为末端：设计决策 / 自然现象）
	- ……
	- 展开"电荷散失量少"：拆分为 人体经鞋底地面散失电荷少 **+** 人体经空气散失电荷少
	- 展开"人体经鞋底地面散失电荷少"：补充中间层 泄漏电流小（公式 Q=I×t，避免整合公式 Q=U×t/R），再用 I=U/R 拆分为 人体电位偏离地电位少（此处少是正向加剧"电流小"，与主干中"多"同因反向）**×** 泄漏电阻大
	- 验证发现"人体电位偏离地电位少"与祖先"人体电位偏离地电位多"等价（反面 + 限定词不同），标注 `：祖先节点已分析（限定词不同，反面）`，不再展开
	- ……
	- 展开"放电通路电阻小"：用公式 R=R_接触+R_皮肤+R_体内+R_门把手 拆分为 接触电阻小 **+** 手指皮肤电阻小 **+** 人体内部电阻小 **+** 门把手电阻小（各项分别判断为末端）
	- ……继续展开，直到队列为空
