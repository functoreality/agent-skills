...
description: >-
  ...
  Use when the user asks to review, improve, update, or refine a skill;
  when the user provides an expert output for comparison with AI output;
  or when the user gives specific feedback about the quality of AI output using
  certain skill.
---
...
- **取舍差异**：专家在某个节点做了 AI 没做的取舍（如选择深入 A 而放弃 B，为什么？）
...
回顾执行过程，识别三类改进信号：
- **困惑点**：执行过程中哪些地方感到不确定、拿不准？
- **经验点**：哪些做法效果好、值得固化为 skill 规则？
